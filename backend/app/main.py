...
from app.models import tenant, user, employee, attendance, shift, ocr, audit, department, invitation  # noqa: F401
...
app.include_router(invitations_router, prefix=settings.API_V1_PREFIX)  # Must be before employees_router to avoid /{employee_id} conflict
