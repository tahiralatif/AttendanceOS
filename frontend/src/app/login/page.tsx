...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col lg:flex-row">
      ...
      {/* Right — Form */}
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 min-h-screen lg:min-h-0">
        <div className="w-full max-w-md animate-slide-up">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-text mb-2">Sign in</h2>
          <p className="text-sm sm:text-base text-text-secondary mb-6 sm:mb-8">
            Enter your credentials to continue
          </p>

          {error && (
            <div className="bg-danger/10 text-danger text-sm px-4 py-3 rounded-xl mb-6 animate-scale-in">
              {error}
            </div>
          )}
