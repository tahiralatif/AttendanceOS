    ...
    <div className="min-h-screen bg-surface overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-lg border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="text-sm font-medium bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark transition-all hover:shadow-lg hover:shadow-primary/20"
            >
              Get Started Free
            </Link>
          </div>
          ...
          >
            <span className={`w-5 h-0.5 bg-text rounded transition-all ${menuOpen ? "rotate-45 translate-y-1" : ""}`} />
            <span className={`w-5 h-0.5 bg-text rounded transition-all ${menuOpen ? "opacity-0" : ""}`} />
            <span className={`w-5 h-0.5 bg-text rounded transition-all ${menuOpen ? "-rotate-45 -translate-y-1" : ""}`} />
          </button>
        </div>
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div className="sm:hidden border-t border-border bg-surface/95 backdrop-blur-lg px-4 py-4 space-y-3">
            <Link href="/login" className="block text-sm font-medium text-text-secondary hover:text-text py-2" onClick={() => setMenuOpen(false)}>
              Sign In
            </Link>
            <Link
              href="/register"
              className="block text-sm font-medium bg-primary text-white px-4 py-2.5 rounded-lg text-center hover:bg-primary-dark transition-all"
      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <div className="inline-flex items-center gap-2 bg-cream px-3 sm:px-4 py-1.5 rounded-full mb-5 sm:mb-6">
          ...
          <p className="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Link
              href="/register"
              className="w-full sm:w-auto bg-primary text-white px-8 py-3.5 rounded-xl font-medium text-sm hover:bg-primary-dark transition-all hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5 text-center"
            >
              Start Free Trial
            </Link>
            <Link
              href="#features"
              className="w-full sm:w-auto bg-white text-text px-8 py-3.5 rounded-xl font-medium text-sm border border-border hover:border-primary/30 transition-all hover:shadow-md text-center"
            >
              See Features
            </Link>
          </div>
      ...
      {/* Features */}
      <section id="features" className="py-16 sm:py-20 px-4 sm:px-6 bg-cream-light">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in">
            <h2 className="text-2xl sm:text-3xl font-bold text-text mb-3 sm:mb-4">Everything you need</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 stagger">
            {[
              ...
              <div
                key={i}
                className="bg-white p-5 sm:p-6 rounded-2xl border border-border hover:border-primary/30 transition-all hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1 animate-slide-up"
              >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-sm sm:text-base text-text-secondary mb-6 sm:mb-8 px-2">
            Free for up to 10 employees. No credit card required.
          </p>
          <Link
            href="/register"
            className="inline-block bg-primary text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl font-medium text-sm sm:text-base hover:bg-primary-dark transition-all hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5"
          >
